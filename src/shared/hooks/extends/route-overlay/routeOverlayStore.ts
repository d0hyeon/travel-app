...
export function registerRouteOverlay<Data>(
  ...
  renderers.set(kind, renderer as RouteOverlayRenderer)
  listeners.forEach((notify) => notify())
}

export function getRouteOverlay(kind: string): RouteOverlayRenderer | undefined {
